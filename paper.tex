...
\begin{abstract}
    ...
    migration across the continent\citep{Henn2018-rf}. Progress is hampered by limited fossil and
    genomic data, as well as variability in prior divergence time estimates\citep{Henn2018-rf}.
    To discriminate among such models, we consider linkage disequilibrium and diversity-based 
    statistics, optimized for rapid, complex demographic inference \citep{Ragsdale2019-nt}.  We
    infer detailed demographic models for populations across Africa, including
    ...
    connected by gene flow over hundreds of thousands of years. Such \emph{weakly
    structured stem} models better explain patterns of
    polymorphism that were previously attributed to contributions from archaic
    hominins in Africa \citep{Plagnol2006-lt,Hammer2011-bx,Hey2018-pw,Ragsdale2019-nt,
Lorente-Galdos2019-vz,Durvasula2020-td}. In contrast to models with archaic introgression, we
    predict fossil remains from coexisting ancestral populations should be
    genetically and morphologically similar, and that an inferred 1--4\% of genetic
    differentiation among contemporary human populations can be attributed to
    genetic drift between stem populations. We show that model misspecification
    explains variation in previous divergence time estimates and argue that
    studying a suite of models is key to robust inferences about deep history.
...
BMH, EGA, EH, and MM designed and conducted participant recruitment.
...
\citep{1000_Genomes_Project_Consortium2015-zq} \sgcomment{This sounds like the Nama are from the 2015 paper. Perhaps: 
We generated a sequencing dataset by combining existing and newly recruited populations who are now part of the 
African Diversity Reference Panel (ADRP) \citep{Gurdasani2015-qy,Pagani2015-pz},
as well as Thousand Genomes Project populations (1KGP)
\citep{1000_Genomes_Project_Consortium2015-zq} 
}. These included the Amhara,
...
retaining Nama individuals with $>70\%$ estimated Khoe-San ancestry, we focused on
...
(EGA), accession number: EGAD00001006198. The African Diversity Reference Panel
can be found at accession: EGAS00001000960.
