...
recruited populations of recent West African or Bantu-speaking ancestry (Figure \ref{fig:1}C). 
...
\begin{figure}[ht!]
    ...
    \caption[width=\textwidth]{
        ...
        (A) \sgcomment{secure coordinates} Select populations from the 1000 Genomes and African Diversity Reference Panels
