...
sapiens} anatomical features appeared across the continent
...
from Central Africa, or pre-Holocene ancient DNA samples, could further test our proposed models.
Given that our samples cover major ancestry components across Africa, we predict that any new admixture signal is likely to be localized.
...
that of the rate to eastern Africans during this period.
