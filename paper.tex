...
flow from them \tdwcomment{add Harvati et al. 2011 ``The Later Stone Age Calvaria from 
...
certain fairly recent \emph{Homo sapiens} fossils (\tdwcomment{add Harvati et al. 2011 
