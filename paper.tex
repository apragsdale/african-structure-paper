...
included the British (GBR) from the 1000 Genomes Project \sgcomment{phase 3} in our demographic
...
To account for population structure prior to 135kya, we allowed \sgcomment {alt: three of our four models allowed} for two or more
...
\sgcomment{This sentence is not clear to me. Do we mean: In other words, the more recent populations are formed by mergers of multiple ancestral populations }
...
have a larger impact on parameter estimates (and thus, uncertainty). To convey model uncertainty, we
