...
following the out-of-Africa migration which was set to 1.5\% at 45kya (Supp. Methods). 
All models infer relatively high subsequent gene flow between the two regions
($m\approx2\times10^{-4}$). Back-to-Africa gene flow at the beginning of the Holocene primarily
