...
\begin{figure}[ht]
    ...
    \caption{
        ...
        paleoanthropological literature into genetically testable demographicmodels \citep{Henn2018-rf}.
       We used these conceptual models as starting points to build detailed parameterized demographic models 
       (Supplementary section \ref{modelspec}) that were then fit to genetic data. 
    }
...
was estimated at 15\%, similar to proportions inferred by \texttt{ADMIXTURE} (Figure~\ref{fig:diversity}).
...
fragmentation-and-coalescence models (such as Figure~\ref{fig:proposed-models}A and C).
