...
\citep{Harvati2011-xs}, Ishango, 
Democratic Republic of Congo (20-25ka) \citep{Crevecoeur2016-cl}, and Nazlet Khater, 
Egypt (35-40ka) \citep{Crevecoeur2012-we}, 
have morphological features that may reflect relatively recent gene flow from archaic hominins \sgcomment{Could we have a citation for this?}. If 
...
infer gene flow at 25ka from one of the stems into West African populations, but 
this should not be interpreted as admixture with an archaic hominin lineage as
differentiation between the stems remains low. The fossil record of Africa is 
sparse during the earlier time period of the stems \aprcomment{($\gtrsim120$ka)},
but of the fossils that date to this time period, 
...
the most morphologically divergent fossils are also unlikely to represent branches that 
