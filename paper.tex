...
%extending deeper in the past than the Relate estimate
% APR: I don't understand this phrase I commented out
...
``Out-of-Africans''. While $120$ka can be interpreted as the basal
\aprcomment{maybe ``earliest'' instead of ``basal''?} human population divergence,
we suggest conceptualizing this event as the time of most recent
shared ancestry among sampled populations. \aprcomment{discounting very recent admixture..?}
``Population divergence'' in population genetics is a complex concept due
...
literature (e.g.\citep{Pagani2015-pz}))
...
10-15ka younger than our fixed parameters, seemingly at odds with the
