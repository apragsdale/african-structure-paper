...
have morphological features that may reflect relatively recent gene flow from archaic hominins \citep{Harvati2011-xs, Crevecoeur2016-cl}, which has been used in support of previously inferred archaic admixture events in human ancestry \cite{Scerri2018-nl, Durvasula2020-td, Bergstrom2021-iw}. 
The weakly structured stem model is not incompatible with archaic admixture having occurred in the ancestry of these fossils, but would imply, by contrast, that such individuals are unlikely to have contributed much ancestry to  contemporary humans. 
The fossil record of Africa is 
