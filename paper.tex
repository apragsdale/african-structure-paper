...
\begin{abstract}
While it is now broadly accepted that \emph{Homo sapiens} origined within Africa, considerable
...
population divergence among contemporary populations occurs 120-135kya\tdwcomment{The standard notation for anyone who studies the past (e.g., paleoanthropologists, geologists) for thousands of years ago is ka, and Ma for millions of years ago. Given this, I think we should use these throughout the paper. I can make the changes, but I didn't want to do so without discussing them}, between
...
archaic hominin admixture models fit directly to the cSFS (for example, compare with Figure~1 in
...
available fossils, some are very similar to contemporary humans (e.g., from Omo
...
ancestries.
\comment{this needs more analyses/citations to back up if included}\aprcomment{but this comment was on the previous version}
