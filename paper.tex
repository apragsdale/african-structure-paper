...
\begin{figure}[t!]
    ...
    \caption{
        \aprcomment{\textbf{fig3} will show some predictions. FST, f4 between 
        contemporaneous populations, for example.}
    }
    \label{fig:3}
\end{figure}
...
\begin{figure}[ht!]
    ...
    \caption{Captions for figure 4. Some validation (cSFS), and coal rate curve examples}
    \label{fig:4}
\end{figure}
