...
to recent population history so as to focus on more ancient events (SI Section \ref{sec:models}). These
...
African populations, set to $60$ka, just prior to the split of Eurasians and East
Africans set to $50$ka. We also fixed the amount of admixture from Neanderthals
to Europeans directly following the out-of-Africa migration which was set to
$1.5\%$ at $45$ka (SI Section~\ref{sec:models}).
...
increase in $N_e$ between $100$ka--$1$Ma extending deeper in the past than the
...
we suggest conceptualizing this event as the time of most recent
...
Therefore, wide variation exists in estimates of divergence time in the literature (e.g.\citep{Pagani2015-pz}))
...
Precipitation does not neatly track interglacial cycles in Africa and heterogeneity across regions may mean 
that beginning of an arid period in eastern Africa is conversely the start of a wet period in southern Africa\citep{Blome2012-lw}.
The rapid rise in sea levels during the MIS 5e interglacial might have triggered migration inland away from the
...
10-15ka younger than our fixed parameters, which seem at odds with the
archaeological record \citep{Hublin2020-nk,Hajdinjak2021-jo} and some
genetic estimates \citep{Schlebusch2017-nl,Kamm2020-vn}. The likely
complexity of the demographic events that we model as population splits
warrants the inclusion of additional Eurasian populations and greater modeling
detail, particularly for the out-of-Africa expansion. However, other features
