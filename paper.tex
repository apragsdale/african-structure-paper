...
\begin{abstract}
    \aprcomment{An attempt at condensing a bit -- this is just under 230 words}
    ...
    migration across the continent. Progress is hampered by limited fossil and
    genomic data, as well as variability in prior divergence time estimates.
    We use linkage disequilibrium and diversity-based statistics, optimized for
    rapid, complex demographic inference to discriminate among such models.  We
    ...
    hominins in Africa. In contrast to models with archaic introgression, we
...
\subsection*{Population structure formation in Africa}
...
``Out-of-Africans''.
% The following sentence may need clarification
...
\sgcomment{Very rough first pass:}
