...
\begin{figure}[ht!]
    ...
    \caption{
        ...
        which we used to estimate coalescence rate trajectories. While
        ...
        population structure. Translating relative cross-coalescence curves
        into population divergences is especially prone to misinterpretation.
    }
    \label{fig:4}
\end{figure}
