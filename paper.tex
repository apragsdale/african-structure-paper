...
\comment{About title: "Contrasting archaic admixture and a weakly structured stem for human originas in Africa" Too long? Inconclusive?}
...
well as variability in dating \comment{prior dataing estimates}.
...
\comment{Any point in citing this paper: https://www.nature.com/articles/s41586-022-04430-9 ?}
...
\begin{figure}[t!]
    ...
    \caption{
        ...
        \comment{If colors have a meaning, explain; also, it may be easier to change the color scheme of figure 1 to match figure 2}
    }
    \label{fig:2}
\end{figure}
...
\begin{figure}[t!]
    ...
    \caption{
        ...
        \comment{This could have a mroe descriptive title saying the take-home point}
