...
\sgcomment{Here my read is that the statement about stem 2 in Mende is shared across both models.
The statement about the Nama is specific to the merger model. Make this explicit?
}
